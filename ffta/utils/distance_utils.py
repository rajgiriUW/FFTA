...
#        self.num_cols = parms_dict['grid_num_cols']
    ...
    def analyze_CPD(self, CPD_avg):
        ...
        """
        # Create 1D arrays
        self._CPD_values(CPD_avg,self.mask)
        self._make_distance_arrays()

        self.CPD_dist, _ = self._CPD_distances(self.CPD_1D_pos, self.mask_on_1D_pos)

        return

    def _CPD_values(self, CPD_avg, mask):
        """
    ...
    def _CPD_distances(self,CPD_1D_pos, mask_on_1D_pos):
        """
